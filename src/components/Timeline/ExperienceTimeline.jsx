  ...
  const experienceData = [
    {
      ...
      type: "Internship",
      description: "Developed and maintained web applications using MERN stack. Collaborated with senior developers to implement new features and optimize existing codebase.",
    ...
    },
    {
      ...
      technologies: ["React.js", "Tailwind CSS", "JavaScript", "HTML5", "CSS3", "Figma"],
      achievements: [
    ...
    },
    {
      ...
      type: "Job Seeking",
      description: "Actively seeking full-time opportunities to apply my MERN stack skills and contribute to innovative projects. Open to both frontend and full-stack roles.",
      technologies: ["React.js", "Node.js", "MongoDB", "Express.js", "Tailwind CSS", "Git", "REST APIs"],
      achievements: [
        "Completed 10+ personal projects showcasing various skills",
        "Continuously learning new technologies and frameworks",
        "Building portfolio to demonstrate technical capabilities",
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {item.technologies.map((tech, idx) => (
                    <span
                      key={idx}
                      className="rounded-full bg-lhilit-1/10 px-3 py-1 text-sm font-medium text-lhilit-1 dark:bg-dhilit-1/10 dark:text-dhilit-1"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <ul className="space-y-1">
                  {item.achievements.map((achievement, idx) => (
                    <li key={idx} className="flex items-start text-sm text-gray-600 dark:text-gray-400">
                      <span className="mr-2 mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-lhilit-1 dark:bg-dhilit-1"></span>
                      {achievement}
                    </li>
                  ))}
                </ul>
